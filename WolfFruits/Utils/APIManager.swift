...
@objc class APIManager: NSObject {
    ...
    func sendPushToken(_ deviceToken: String, onComplete completeBlock: @escaping () -> Void) {
        ...
        Alamofire.request("https://sevas.site/loguser", method: .post, parameters: params, encoding: JSONEncoding.default, headers: ["Content-Type" : "application/json"]).responseString(completionHandler: { response in
